...
'@
        ...
        Get-HueBridge @GetHueBridgeParameters |
            Where-Object {$PSCmdlet.ShouldProcess("Delete ResourceLink$($_.Name) ($($_.ID))")}| Send-HueBridge -Method DELETE -Command {"resourcelinks/$($_.ID)"}
    }
}
